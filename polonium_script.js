  ...
  getGlobal().registerPlugin(lfScriptId, 'yt-playback', function() {
    ...
    function setupMainMessageHandler() {
      ...
      window.addEventListener("message", function (e) {
        if (["https://www.youtube.com", "https://www.youtube-nocookie.com"].indexOf(e.origin) !== -1
            && e.data !== undefined) {
          handleYtEvent(e);
        }
      });
    ...
    function getYtVideoTitle(videoData) {
      if (!videoData) { return; }
